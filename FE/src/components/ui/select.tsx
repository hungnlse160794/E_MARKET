...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-xl py-3 pl-4 pr-10 text-sm font-bold text-slate-600 outline-none transition-colors focus:bg-indigo-50 focus:text-indigo-600 data-disabled:pointer-events-none data-disabled:opacity-50",
      className
    )}
    {...props}
  >
